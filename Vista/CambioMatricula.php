...
echo "<form action='../Controlador/Alterar.php' method='POST'>";
...
echo "<label for='1' class='container__label'>NUMERO MATRICULA</label>";
echo '<input type="number" class="container__input" name="txt1" value="'.$_GET["dato1"].'">';
echo "<label for='2' class='container__label'>LUGAR MATRICULA</label>";
echo '<input type="text" class="container__input" name="txt2" value="'.$_GET["dato2"].'">';
echo "<label for='3' class='container__label'>FECHA MATRICULA</label>";
echo '<input type="date" class="container__input" name="txt3" value="'.$_GET["dato3"].'">';
