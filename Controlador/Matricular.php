...
include "../Modelo/Matriculacion.php";
...
if($retornar == 1){
    include "../Vista/MATTT.php";
    echo "<p style='background-color:#138D75;color:white;text-align:center;clear:both;font-family: 'Source Sans Pro', sans-serif'>MATRICULA REGISTRADA EXITOSAMENTE</P>";
    
}
else if(str_contains($retornar, 'SQLSTATE[23000]: Integrity constraint violation: 1062')){
    include "../Vista/MATTT.php";
    echo "<p style='background-color:#DED407;color:white;text-align:center;clear:both;font-family: 'Source Sans Pro', sans-serif'>NUMERO DE MATRICULA REPETIDO, REGISTRO DE MATRICULA FALLIDO</P>";
